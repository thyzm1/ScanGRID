...
export default function UnplacedDock({
  ...
  return (
    <div className="w-32 min-[901px]:w-44 lg:w-48 h-full z-10 flex flex-col gap-2">
      <div className="bg-[var(--color-bg-secondary)]/80 backdrop-blur-md rounded-xl shadow-lg border border-[var(--color-border)] overflow-hidden flex flex-col pointer-events-auto h-full max-h-[52vh] min-[901px]:max-h-none">
        <div className="p-2.5 min-[901px]:p-3 border-b border-[var(--color-border)] bg-black/5 dark:bg-white/5 backdrop-blur-sm">
              ...
              <div
                ...
                className={`
                  ...
                  ${isSelected
                    ...
                    : 'border-[var(--color-border)] bg-[var(--color-bg)]/40 backdrop-blur-sm hover:border-blue-300 dark:hover:border-blue-700 hover:bg-[var(--color-bg)]/60'
                  }
                `}
              >
                {editMode === 'edit' && (
