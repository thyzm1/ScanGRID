  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-[var(--color-bg-secondary)]/80 backdrop-blur-md rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden shadow-2xl border border-[var(--color-border)]"
      >
        {/* Header */}
